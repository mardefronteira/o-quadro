const dataBase = {
  ...
  },
  {
    ...
    imgDestaque: { src: '/imagens/euller-entre-dois-mundos-vertical.jpg', desc: 'descrição da imagem', titulo: 'Titulo da Imagem' },
    galeria: [{ src: '/imagens/euller-entre-dois-mundos-vertical.jpg', desc: 'descrição da imagem', titulo: 'Titulo da Imagem' }],
    titulo: 'Euller Miller Entre Dois Mundos',
    imgPoster: { src: '/imagens/euller-entre-dois-mundos-vertical.jpg', desc: 'descrição da imagem', titulo: 'Titulo da Imagem' },
    ...
    galeria: [{ src: '/imagens/cartaz_dias-de-trovao.jpg', desc: 'descrição da imagem', titulo: 'Titulo da Imagem' }],
